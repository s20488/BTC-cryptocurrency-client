...
@Component
public class BtcProjectService {
    ...
    public BtcProjectService(@Value("${bitcoin.rpc.url}") String rpcUrl,
    ...
    public String getNewAddressAndGenerateQRCode(double amount) throws IOException, WriterException {
